const ToggleSwitch = ({ id, label, checked, onChange }) => {
  return (
    <div className="flex items-center">
      ...
      <div className="relative inline-block w-10 align-middle select-none text-green-800">
        <input
          type="checkbox"
          id={id}  
