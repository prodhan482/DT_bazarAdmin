...
import { addItem } from "../articleService"
...
function AddArticle({ onClose, onSuccess }) {
  ...
  return (
    <AddFormLayout title="Add Article" onSubmit={handleSubmit} onClose={onClose}>
      <ImageUploader
      ...
      <TextField label="Title"
            ...
            required 
      />
      <TextEditorDescriptionField label="Description"
            value={description}
