  ...
  useEffect(() => {
    ...
    async function fetchData () {
      ...
      try {
        ...
        const response = await getAllOrdersByStatus(canceled)
        setCanceledOrderList(response)
...
export default ViewCanceledOrders;
